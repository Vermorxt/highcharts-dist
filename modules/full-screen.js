/*
 Highstock JS v8.0.4 (2020-03-26)
...
this.unbindFullscreenEvent();this.isOpen=!1;this.setButtonText()};a.prototype.open=function(){var b=this,a=b.chart;if(b.browserProps){b.unbindFullscreenEvent=d(a.container.ownerDocument,b.browserProps.fullscreenChange,function(){b.isOpen?(b.isOpen=!1,b.close()):(b.isOpen=!0,b.setButtonText())});if(a.container.parentNode instanceof Element){var c=a.container.parentNode[b.browserProps.requestFullscreen]();if(c)c["catch"](function(){alert("Full screen is not supported inside a frame.")})}d(a,"destroy",
b.unbindFullscreenEvent)}};a.prototype.setButtonText=function(){var a,c=this.chart,d=c.exportDivElements,e=c.options.exporting,f=null===(a=null===e||void 0===e?void 0:e.buttons)||void 0===a?void 0:a.contextButton.menuItems;a=c.options.lang;(null===e||void 0===e?0:e.menuItemDefinitions)&&(null===a||void 0===a?0:a.exitFullscreen)&&a.viewFullscreen&&f&&d&&d.length&&(d[f.indexOf("viewFullscreen")].innerHTML=this.isOpen?a.exitFullscreen:e.menuItemDefinitions.viewFullscreen.text||a.viewFullscreen)};a.prototype.toggle=
function(){this.isOpen?this.close():this.open()};return a}();a.Fullscreen=f;d(c,"beforeRender",function(){this.fullscreen=new a.Fullscreen(this)});return a.Fullscreen});c(a,"masters/modules/full-screen.src.js",[],function(){})});
